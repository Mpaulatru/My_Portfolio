...
export const projects = [
  {
    ...
    image: '/projects/intelretail.png',
    description:
  ...
  },
  {
    ...
    description:
      'Ejercicio guiado del curso de Análisis de Datos para conectar una base de datos SQLite (chinook.db) desde Google Colab y ejecutar consultas SQL con Python y pandas: listado de tablas, inspección de esquemas y consultas sobre datos de clientes.',
